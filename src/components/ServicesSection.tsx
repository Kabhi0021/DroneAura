...
const services = [{
  ...
  features: ["Cinematic wedding videos", "Aerial couple portraits", "Reception venue shots", "Same-day highlight reel"],
  price: "₹25,000",
  ...
  features: ["Multiple location shoots", "Edited photo gallery", "Social media packages", "Print-ready formats"],
  price: "₹15,000",
  ...
  features: ["Property overview shots", "Neighborhood context", "Virtual tour integration", "Quick 24-hour delivery"],
  price: "₹8,000",
  ...
  features: ["Event documentation", "Product showcase videos", "Corporate facility tours", "Team photography"],
  price: "₹20,000",
  ...
  features: ["Destination showcases", "Travel documentaries", "Tourism promotion", "Adventure coverage"],
  price: "₹18,000",
  ...
  features: ["4K video production", "Professional editing", "Multiple drone setup", "Director collaboration"],
  price: "₹35,000",
  image: "https://images.unsplash.com/photo-1487887235947-a955ef187fcc?w=800&h=600&fit=crop"
}];
export function ServicesSection() {
  return <section id="services" className="py-20 bg-gradient-to-br from-background to-muted">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-card rounded-2xl p-8 shadow-floating">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-fuschia text-white px-8 py-3 rounded-lg font-semibold hover:shadow-floating transition-smooth hover:scale-105" onClick={() => document.getElementById('booking')?.scrollIntoView({
              behavior: 'smooth'

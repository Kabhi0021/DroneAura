  ...
  ].join(" "),
  {
    variants: {
      variant: {
        ...
        scroll: "[background:linear-gradient(90deg,#e32cea_2%,#f61dce_8%,#f35bbf_92%,#f16dac_98%)] text-[#fff] rounded-3xl shadow-md hover:bg-[linear-gradient(90deg, #06b6f0 0%, #3b30ff 15%, #ad00d3 85%, #e32cea 100%)] border-0 flex items-center justify-center",
        outline: "",
        outlineClicked: "",
      },
      size: {
